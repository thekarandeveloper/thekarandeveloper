  ...
  return (
    <div className="card-container intro">
      ...
      <div className="icon-bars">
        ...
        <a className="icon-container label" target="_blank" href="https://twitter.com/karankumarcv">
          <div><FaXTwitter /></div>
          <div className="icon-label"><span>Thoughts</span></div>
        </a>
        <a className="icon-container label" target="_blank" href="https://www.linkedin.com/in/karankumarcv/">
          <div><IoLogoLinkedin /></div>
          <div className="icon-label"><span>Work Life</span></div>
        </a>
        <a className="icon-container label" target="_blank" href="https://www.instagram.com/karankumarcv/">
